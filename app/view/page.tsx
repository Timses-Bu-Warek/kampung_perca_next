  ...
  return (
    <main>
      ...
      <div className="container grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-600">
            ...
            Blanditiis, nesciunt. Vitae, at officiis. Amet odit eius quaerat.
            Harum possimus quidem provident tenetur placeat, corporis, molestias
            nisi ipsam, animi deserunt quod.
          </p>
          ...
          {/* <!-- quantity --> */}
          <div className="mt-4">
            <h3 className="text-gray-800 uppercase font-inter pt-4">
              Quantity
            </h3>
      ...
      <div className="container pb-16">
        <h3 className="border-b border-gray-200 font-montserrat text-gray-800 pb-3 font-medium pt-6">
          Product Detail
        </h3>
        <div className="w-3/5 pt-4">
          <div className="text-gray-600 space-y-3">
            ...
            <p>
              ...
              optio numquam recusandae omnis alias velit, nostrum ipsam. Iste
              minima quam unde sit error voluptatum itaque a ea nihil quisquam.
              Repudiandae.
            </p>
          </div>
          {/* <!-- table detail --> */}
          <table className="table-auto border-collapse text-left text-gray-600 text-sm mt-6">
            <tbody>
              <tr>
                <td className="py-2 px-4 border border-gray-300 w-40 font-inter font-medium">
                  Weight
                </td>
