...
(a = this),
  (e = function () {
    ...
    var l = (a.navigator || {}).userAgent,
      ...
      n = e;
    f.document,
      n.documentElement && n.head && 'function' == typeof n.addEventListener && n.createElement,
    ...
    var p = d(
        ...
        o(g, b, { solid: 'fass', regular: 'fasr', light: 'fasl', thin: 'fast' }),
        g),
      ),
      n =
        (d(
          ...
          o(l, b, { fass: 'fa-solid', fasr: 'fa-regular', fasl: 'fa-light', fast: 'fa-thin' }),
          l),
        ),
        d(
          (o((a = {}), i, {
        ...
        d(
          (o((e = {}), i, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }),
          o(e, b, { 900: 'fass', 400: 'fasr', 300: 'fasl', 100: 'fast' }),
          e),
        ),
        ...
        (function (a) {
          ...
          (function (a, e) {
            if (a) {
              ...
              return 'Map' === (l = 'Object' === l && a.constructor ? a.constructor.name : l) ||
                'Set' === l
                ? Array.from(a)
    ...
    return (
      (function (a) {
        try {
          for (var e = arguments.length, l = new Array(1 < e ? e - 1 : 0), r = 1; r < e; r++)
            l[r - 1] = arguments[r];
          a.apply(void 0, l);
        } catch (a) {
          if (!u) throw a;
