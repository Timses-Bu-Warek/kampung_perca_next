...
!(function () {
  ...
  function s(t, a, e) {
    return (
      a in t
        ? Object.defineProperty(t, a, { value: e, enumerable: !0, configurable: !0, writable: !0 })
        : (t[a] = e),
      t
    );
  }
  ...
  var T = R(
    ...
    D = R(
      ...
      s(f, L, { solid: 'fass', regular: 'fasr', light: 'fasl', thin: 'fast' }),
      f),
    ),
    F = R(
      (s((u = {}), I, {
      ...
      s(u, L, { fass: 'fa-solid', fasr: 'fa-regular', fasl: 'fa-light', fast: 'fa-thin' }),
      u),
    ),
    H = R(
      (s((b = {}), I, {
      ...
      s(b, L, { 'fa-solid': 'fass', 'fa-regular': 'fasr', 'fa-light': 'fasl', 'fa-thin': 'fast' }),
      b),
    ),
    ...
    X = R(
      (s((c = {}), I, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }),
      s(c, L, { 900: 'fass', 400: 'fasr', 300: 'fasl', 100: 'fast' }),
      c),
    ),
  ...
  function ot(t) {
    return (
      t.size !== $.size || t.x !== $.x || t.y !== $.y || t.rotate !== $.rotate || t.flipX || t.flipY
    );
  }
  function st() {
    var t,
  ...
  y &&
    ((dt = (h.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(h.readyState)) ||
  ...
  function It() {
    ...
    (Ct = a.names), (jt = a.unicodes), (Nt = Dt(J.styleDefault, { family: J.familyDefault }));
  }
  function Lt(t, a) {
    return (Pt[t] || {})[a];
  }
  ...
  function Rt(t) {
    return Ct[t] || { prefix: null, iconName: null };
  }
  (f = function (t) {
      ...
      return (
        xt[a]
          ...
          : -1 < zt[o].indexOf(a)
            ...
            : e
              ? (t.iconName = e)
              : a !== J.replacementClass && a !== i[I] && a !== i[L] && t.rest.push(a),
        !n &&
          t.prefix &&
          t.iconName &&
          ...
          'far' !== t.prefix || xt.far || !xt.fas || J.autoFetchSvg || (t.prefix = 'fas')),
        t
      );
    }, Tt());
    return (
      ...
      a.prefix ||
        ...
        ((a.prefix = 'fass'), (a.iconName = Yt(a.prefix, a.iconName) || a.iconName)),
    ...
    Kt = {
      ...
      dom: {
        i2svg: function () {
          ...
          return y
            ? (Bt('beforeI2svg', t), qt('pseudoElements2svg', t), qt('i2svg', t))
      ...
      parse: {
        icon: function (t) {
          ...
          if ('object' === i(t) && t.prefix && t.iconName)
            return { prefix: t.prefix, iconName: Yt(t.prefix, t.iconName) || t.iconName };
          ...
          if ('string' == typeof t && (-1 < t.indexOf(''.concat(J.cssPrefix, '-')) || t.match(W))) {
            ...
            return { prefix: a.prefix || Nt, iconName: Yt(a.prefix, a.iconName) || a.iconName };
          }
          return 'string' == typeof t ? { prefix: Nt, iconName: Yt(Nt, t) || t } : void 0;
        },
      },
      library: Gt,
  ...
  function Zt(t) {
    ...
    d && (b.attributes[O] = ''),
      c &&
        (b.children.push({
          tag: 'title',
          attributes: { id: b.attributes['aria-labelledby'] || 'title-'.concat(l || at()) },
          children: [c],
        }),
    ...
    return (
      ...
      s
        ? ((v = (p = t).prefix),
          ...
          (h = p.children),
          (y = p.attributes),
          (p = !0 === (p = p.symbol) ? ''.concat(v, '-').concat(J.cssPrefix, '-').concat(g) : p),
          [
            {
              tag: 'svg',
              attributes: { style: 'display: none;' },
              children: [{ tag: 'symbol', attributes: k(k({}, y), {}, { id: p }), children: h }],
            },
          ])
        : ((g = (v = t).children),
          (y = v.main),
  ...
  function na(i, r) {
    ...
    return (
      ...
      new Promise(function (t, a) {
        ...
        if (
          ('fa' === o && ((n = Rt(i) || {}), (i = n.iconName || i), (r = n.prefix || r)),
          i && r && ta[r] && ta[r][i])
        )
          return t(aa(ta[r][i]));
        (e = i),
  ...
  var oa = J.measurePerformance && d && d.mark && d.measure ? d : { mark: ia, measure: ia },
    sa = 'FA "6.5.2"',
    ca = {
      begin: function (t) {
        return (
  ...
  function pa(e, t) {
    ...
    0 === e.length
      ? n()
      : (J.mutateApproach === E ? g.requestAnimationFrame || ba : ba)(function () {
  ...
  function ka(t) {
    ...
    p &&
          ...
          et(t).forEach(function (t) {
            ...
            'childList' === t.type &&
              ...
              'attributes' === t.type &&
                ...
                (e = e.getAttribute ? e.getAttribute(C) : null),
                n && e)
                  ? ((e = (a = Ht(nt(t.target))).prefix),
                    (a = a.iconName),
                    t.target.setAttribute(S, e || i),
                    a && t.target.setAttribute(C, a))
                  : (a = t.target) &&
                    a.classList &&
      ...
      y && ya.observe(t, { childList: !0, attributes: !0, characterData: !0, subtree: !0 }));
  }
  function wa(t) {
    ...
    return (
      ...
      (i.iconName && i.prefix) ||
        (i.prefix &&
          0 < n.length &&
          (i.iconName =
            ((e = i.prefix), (n = t.innerText), (St[e] || {})[n] || Lt(i.prefix, yt(t.innerText)))),
        !i.iconName &&
          J.autoFetchSvg &&
          t.firstChild &&
  ...
  function xa(t, a) {
    var e = 1 < arguments.length && void 0 !== a ? a : { styleParser: !0 },
      ...
      s =
        ...
        J.autoA11y &&
          (n
            ? (a['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(s || at()))
    ...
    if (t) {
      ...
      return Qt(k({ type: 'icon' }, t), function () {
        return (
          ...
          J.autoA11y &&
            (s
              ? (l['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(c || at()))
              : ((l['aria-hidden'] = 'true'), (l.focusable = 'false'))),
          Zt({
            icons: {
              main: aa(b),
              mask: r ? aa(r.icon) : { found: !1, width: null, height: null, icon: {} },
            },
            prefix: m,
            iconName: d,
            transform: k(k({}, $), n),
      ...
      u && 'none' !== d && '' !== d
        ? ((s = l.getPropertyValue('content')),
          ...
          (d = (l =
            ...
            (c =
              ...
              c <= 57343
                ...
                : d),
            (d = Ea[0] <= c && c <= Ea[1]),
            { value: yt((c = 2 === l.length && l[0] === l[1]) ? l[0] : l), isSecondary: d || c }))
            .value),
          (c = l.isSecondary),
          ...
          l &&
            ...
            (l = Lt('fas', l)),
            (l = d ||
              (l ? { prefix: 'fas', iconName: l } : null) || { prefix: null, iconName: null })
              .iconName &&
              l.prefix &&
              ((u = l.iconName), (n = l.prefix))),
          !u || c || (f && f.getAttribute(S) === n && f.getAttribute(C) === i)
            ? e()
            : (b.setAttribute(v, i),
              f && b.removeChild(f),
              ((o = (r = {
              ...
              na(u, n)
                .then(function (t) {
                  ...
                  '::before' === p ? b.insertBefore(t, b.firstChild) : b.appendChild(t),
        ...
        hooks: function () {
          return {
            ...
            watch: function (t) {
              ...
              Ra ? ha() : ka(Xt('mutationObserverCallbacks', { observeMutationsRoot: t }));
            },
          };
        },
      },
        ...
        provides: function (t) {
          t.generateAbstractMask = function (t) {
            var a = t.children,
              ...
              i = { tag: 'rect', attributes: k(k({}, Ta), {}, { fill: 'white' }) },
              f = c.children ? { children: c.children.map(Da) } : {},
              f = {
                tag: 'g',
                attributes: k({}, o.inner),
                children: [Da(k({ tag: c.tag, attributes: k(k({}, c.attributes), o.path) }, f))],
              },
