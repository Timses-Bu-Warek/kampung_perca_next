...
!(function () {
  ...
  function M(s, c) {
    ...
    return (
      Object.getOwnPropertySymbols &&
        ((l = Object.getOwnPropertySymbols(s)),
        c &&
  ...
  function e(c, s, l) {
    return (
      s in c
        ? Object.defineProperty(c, s, { value: l, enumerable: !0, configurable: !0, writable: !0 })
        : (c[s] = l),
      c
    );
  }
  ...
  var t = f(
      ...
      e(i, m, { solid: 'fass', regular: 'fasr', light: 'fasl', thin: 'fast' }),
      i),
    ),
    V =
      (f(
        ...
        e(l, m, { fass: 'fa-solid', fasr: 'fa-regular', fasl: 'fa-light', fast: 'fa-thin' }),
        l),
      ),
      f(
        (e((c = {}), r, {
      ...
      f(
        (e((s = {}), r, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }),
        e(s, m, { 900: 'fass', 400: 'fasr', 300: 'fasl', 100: 'fast' }),
        s),
      ),
  ...
  function u(c, s, l) {
    var z = (2 < arguments.length && void 0 !== l ? l : {}).skipHooks,
      l = void 0 !== z && z,
      z = d(s);
    'function' != typeof n.hooks.addPack || l
      ? (n.styles[c] = a(a({}, n.styles[c] || {}), z))
      : n.hooks.addPack(c, d(s)),
      'fas' === c && u('fa', s);
  }
  var p = {
    0: [
  ...
  !(function (c) {
    try {
      for (var s = arguments.length, l = new Array(1 < s ? s - 1 : 0), z = 1; z < s; z++)
        l[z - 1] = arguments[z];
      c.apply(void 0, l);
    } catch (c) {
      if (!C) throw c;
